      ...
      <div className="mt-10 flex w-full max-w-2xl flex-col p-2.5">
        ...
        <div className="mt-5 flex flex-row items-center space-x-3 text-lg text-[#FFFFFF90]">
          ...
          <a
            ...
            href="https://github.com/rishi-raj-jain/edgio-reactjs-example"
          >
            rishi-raj-jain/edgio-reactjs-example
          </a>
        </div>
        <a className="mt-5" target="_blank" href="https://app.layer0.co/deploy?repo=https://github.com/rishi-raj-jain/edgio-reactjs-example">
